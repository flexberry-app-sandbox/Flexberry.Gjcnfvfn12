...
namespace IIS.Gjcnfvfn12
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Gjcnfvfn12.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Gjcnfvfn12.Пользователь fПользователь;
        ...
        public virtual IIS.Gjcnfvfn12.Оплата Оплата
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Gjcnfvfn12.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Gjcnfvfn12.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Gjcnfvfn12.Транзакция));
                }
            }
        }
    }
