...
namespace IIS.Gjcnfvfn12
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Gjcnfvfn12.Статусы fСтатус;
        
        private IIS.Gjcnfvfn12.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Gjcnfvfn12.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Gjcnfvfn12.Статусы Статус
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.Статусы result = this.fСтатус;
        ...
        public virtual IIS.Gjcnfvfn12.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Gjcnfvfn12.DetailArrayOfЯчейка(this);
                }
                IIS.Gjcnfvfn12.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Gjcnfvfn12.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Gjcnfvfn12.Постамат));
                }
            }
        }
    }
