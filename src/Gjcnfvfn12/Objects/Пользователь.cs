    ...
    public class Пользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПользовательE", typeof(IIS.Gjcnfvfn12.Пользователь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПользовательL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПользовательL", typeof(IIS.Gjcnfvfn12.Пользователь));
                }
            }
        }
    }
