...
namespace IIS.Gjcnfvfn12
{
    ...
    public class Посылка : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "Транзакция"})]
        [NotNull()]
        public virtual IIS.Gjcnfvfn12.Транзакция Транзакция
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.Транзакция result = this.fТранзакция;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Gjcnfvfn12.Хранение.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосылкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаE", typeof(IIS.Gjcnfvfn12.Посылка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПосылка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Gjcnfvfn12.DetailArrayOfПосылка members)

        // *** End programmer edit section *** (IIS.Gjcnfvfn12.DetailArrayOfПосылка members)
        ...
        /// </summary>
        public DetailArrayOfПосылка(IIS.Gjcnfvfn12.Хранение fХранение) : 
                base(typeof(Посылка), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Gjcnfvfn12.Посылка this[int index]
        {
            get
            {
                return ((IIS.Gjcnfvfn12.Посылка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Gjcnfvfn12.Посылка dataobject)
        {
