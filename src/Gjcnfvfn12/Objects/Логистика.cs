...
namespace IIS.Gjcnfvfn12
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Gjcnfvfn12.Состояние fСостояние;
        
        private string fИнформация;
        
        private IIS.Gjcnfvfn12.СлужбаДоставки fСлужбаДоставки;
        ...
        public virtual IIS.Gjcnfvfn12.Состояние Состояние
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.Состояние result = this.fСостояние;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Gjcnfvfn12.СлужбаДоставки.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        public virtual IIS.Gjcnfvfn12.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Gjcnfvfn12.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Gjcnfvfn12.Логистика));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЛогистика : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Gjcnfvfn12.DetailArrayOfЛогистика members)

        // *** End programmer edit section *** (IIS.Gjcnfvfn12.DetailArrayOfЛогистика members)
        ...
        /// </summary>
        public DetailArrayOfЛогистика(IIS.Gjcnfvfn12.СлужбаДоставки fСлужбаДоставки) : 
                base(typeof(Логистика), ((ICSSoft.STORMNET.DataObject)(fСлужбаДоставки)))
        {
        }
        
        public IIS.Gjcnfvfn12.Логистика this[int index]
        {
            get
            {
                return ((IIS.Gjcnfvfn12.Логистика)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Gjcnfvfn12.Логистика dataobject)
        {
